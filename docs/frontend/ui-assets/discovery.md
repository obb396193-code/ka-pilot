...
> 核验日期：2026-08-19。以下均为官方文档/官方仓库已经证实的公开源码候选，但目前只是 `discovery-only`：未并入 5,996 条主目录，也未下载源码。
...
| Animate UI | shadcn 产品感 + 克制统一动效 | Dialog/Tabs/Button 过渡、背景、动画图标 | MIT + Commons Clause | 中高优先；可用于应用，但限制直接销售/再分发组件本身 |
