...
coss 仓库采用混合许可证：仓库默认 AGPL-3.0，官方 README 明确 `apps/ui` 和 legacy `apps/origin` 保持 MIT。每个复制文件必须确认来自 MIT 范围或官方 UI Registry，并记录路径；不要从仓库其他目录顺手复制 AGPL 文件。
...
- Repository/licensing：<https://github.com/cosscom/coss>
