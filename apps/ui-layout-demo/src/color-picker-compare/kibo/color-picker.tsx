// 来源：Kibo UI color-picker（MIT）https://www.kibo-ui.com/r/color-picker.json ，缓存 docs/frontend/ui-assets/source-cache/kibo-ui/color-picker.json
// 适配：仅 import 路径指向本仓 shadcn 组件，行为未改
"use client";
