...
import {
  ...
  ChartTooltipContent,
  type ChartConfig,
} from "@/sidebar/shadcn-dashboard/ui/chart";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/sidebar/shadcn-dashboard/ui/select";
import {
  ToggleGroup,
  ToggleGroupItem,
} from "@/sidebar/shadcn-dashboard/ui/toggle-group";
...
export function ChartAreaInteractive() {
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>近 90 日转化趋势</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            媒体回传与后端真实转化对比
          </span>
          <span className="@[540px]/card:hidden">近 3 个月</span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
