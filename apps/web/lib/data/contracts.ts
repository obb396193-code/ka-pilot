...
export const stableDataQueryErrorSchema = z.object({ code: stableDataQueryErrorCodeSchema, message: z.string().min(1), retryable: z.boolean(), requestId: z.string().min(1) }).strict()
...
const reconcileMetricSchema = z.object({ kaData: metricValueSchema, platform: metricValueSchema, delta: metricValueSchema, deltaRate: metricValueSchema, comparable: z.boolean(), reason: z.string().min(1).optional() }).strict()
