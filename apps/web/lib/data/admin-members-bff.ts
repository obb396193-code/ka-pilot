import { adminMembersResponseSchema, adminMemberGrantsCommandResponseSchema } from "../../../../packages/domain/src/admin-members.ts"
...
// v1.9.46 ①：授权读按 identity 解析目标个人空间，解析出两个时后端回 409 CONFLICT。
const statuses = { INVALID_REQUEST: 400, UNAUTHORIZED: 401, FORBIDDEN: 403, NOT_FOUND: 404, CONFLICT: 409, READ_ONLY_ROLE: 403,
...
export async function handleAdminMembersRequest(request: Request, dependencies: {
  ...
  try {
    ...
    const schema = identityId === undefined ? adminMembersResponseSchema : adminMemberGrantsCommandResponseSchema
