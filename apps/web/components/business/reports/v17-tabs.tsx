...
export function MonthlyTab() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-2 text-sm"><TypeChip>月度经营</TypeChip><span>{data.month} 月度推送</span><span className="text-xs text-muted-foreground">推送为需确认的群卡片（拍板三键）+ 长图</span><Button size="sm" className="ml-auto" onClick={() => toast.success("已推送月度卡片")}><IconBrandDingtalk />推送</Button></div>
      <Card>
