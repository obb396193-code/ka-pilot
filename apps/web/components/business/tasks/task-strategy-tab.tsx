      ...
      <Card>
        <CardHeader>
          <div className="flex flex-wrap items-start justify-between gap-2">
            ...
            <div className="flex gap-2"><Button asChild size="sm" variant="outline"><Link href="/data?tab=strategy&view=library">看方案详情</Link></Button><Button size="sm" variant="ghost" onClick={() => toast("已解绑", { description: `DELETE /strategies/${binding.strategy.id}/bind/${taskId}` })}><IconUnlink />解绑</Button></div>
          </div>
        </CardHeader>
