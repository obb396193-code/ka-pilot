...
test("starter pack contains only real public-source assets across the approved showroom sources", async () => {
  ...
  assert.ok(starter.roots.length <= 75, "starter pack should stay curated instead of mirroring everything");
