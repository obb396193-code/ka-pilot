...
describe("HTTP once child's deployment trust configuration", () => {
  it("forwards extra CA without copying trigger, session or shared service identities", () => {
    const result = workerOnceChildEnvironment({ workspaceId: "00000000-0000-4000-8000-000000000001", media: "KUAISHOU", mode: "full", databaseUrl: "postgres://synthetic-only", qihangBaseUrl: "https://synthetic.invalid/get_data", maxMs: 30000, leaseSeconds: 60, sourceTimeZone: null }, {
