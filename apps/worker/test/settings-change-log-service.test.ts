...
const fixture = JSON.parse(readFileSync(new URL("../../../packages/contract/fixtures/settings/change-log.json", import.meta.url), "utf8"));
...
describe("P194 change log service, not yet production registered", () => {
