...
# Account Callback Deduction（账户回传扣量，走启航域名 qh.alibaba-inc.com）
DEDUCTION_APP_KEY = "55cZncAFBZ6QfB5BksqZdHgmhYXk9ww"
DEDUCTION_LIST_PATH = "/qihang/api/rta_auto/tmp/callback_deduction/list"
DEDUCTION_UPDATE_PATH = "/qihang/api/rta_auto/tmp/callback_deduction"

# Signature Usage（素材签名使用次数查询，GET，走 dataservice-api 域名）
SIGNATURE_USAGE_BASE_URL = "https://dataservice-api.dw.alibaba-inc.com"
SIGNATURE_USAGE_PATH = "/project/23017/get_media_signature_usage"
SIGNATURE_USAGE_APP_CODE = "E1A16AACB57E4B07BD3532FC1CAA7330"
