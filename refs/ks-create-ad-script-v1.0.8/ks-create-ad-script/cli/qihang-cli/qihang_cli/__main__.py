...
from .commands import account, deduction, link, material, signature, textpool
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "  deduction  账户回传扣量查询与修改（qh.alibaba-inc.com）\n"
            "  signature  素材签名使用次数查询（dataservice-api）\n"
    ...
    deduction.register(subparsers, common)
    signature.register(subparsers, common)
    return parser
