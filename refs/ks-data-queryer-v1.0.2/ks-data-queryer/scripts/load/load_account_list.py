...
media 默认 KUAISHOU。参见 connectors/account-list.md。

示例（在 ks-data-queryer/scripts/load 目录下）：
  python load_account_list.py --page-size 50

  python load_account_list.py --one-page --page-num 1

  python load_account_list.py -m KUAISHOU --keyword 电商
"""
...
# 注：快手 account 列表比腾讯多返回 account_name
_ACCOUNT_LIST_KEYS = (
    "account_id",
    "account_name",
    "task_id",
